...
namespace Vsite.CSharp.KontrolaToka
{
    class Yield
    {
        static void Main(string[] args)
        {
            ...
            // Postaviti prekidnu točku (breakpoint) na 'in' u donjoj petlji foreach, pokrenuti program 
            // i nakon svakog prekida napraviti 'Step Into' (F11) i pratiti izvođenje metode DajKvadrat
