...
namespace Vsite.CSharp.KontrolaToka
{
    ...
    static class GrananjeSwitchSObrascima
    {
        ...
        public static void IspišiOsobu(Osoba o)
        {
            switch (o)
            {
                // :073 Dodati case za objekt tipa Osoba koji će ispisati $"Osoba: {o1.Ime}". Pokrenuti program i provjeriti ispis.
                case Osoba o1 when o.GetType() == typeof(Osoba):
                ...
                case Student s when o.GetType() == typeof(Student) && s.Godina <= 4:
