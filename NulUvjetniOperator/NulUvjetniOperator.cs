...
namespace Vsite.CSharp.KontrolaToka
{
    class NulUvjetniOperator
    {
        ...
        {
            //  Korištenjem nul-uvjetnog (null conditional) operatora ?. vratiti rezultat metode ToString na prosljeđenom objektu
            // ako je različit od nule, u protivnom vratiti nul-referencu
            return obj?.ToString();
