...
namespace Vsite.CSharp.KontrolaToka
{
    static class NulUvjetniOperator
    {
        ...
        {
            // :050 Korištenjem nul-uvjetnog (null conditional) operatora ?. vratiti rezultat metode
            // ToString na prosljeđenom objektu ako je različit od nule, u protivnom vratiti nul-referencu
