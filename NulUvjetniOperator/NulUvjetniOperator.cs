...
{
    static class NulUvjetniOperator
    {
        public static string? PozoviToString(object? obj)
        {
            // DID_IT:050 Korištenjem nul-uvjetnog (null conditional) operatora ?. vratiti rezultat metode ToString na prosljeđenom objektu ako je različit od nule, u protivnom vratiti nul-referencu
            return obj?.ToString();
            throw new NotImplementedException();
        }

        // DID_IT:051 Pokrenuti program i provjeriti ispis

        // DID_IT:052 Pokrenuti testove i provjeriti prolaze li sva 3 testa iz grupe TestNulUvjetnogOperatora
