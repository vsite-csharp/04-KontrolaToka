...
namespace Vsite.CSharp.KontrolaToka
{
    class NeograničeniNizYield
    {
        ...
        // 130 Implementirati metodu tako da omogućava vraćanje beskonačnog niza slučajnih brojeva. 
        ...
        {
            var slučajniBroj = new Random();

            while (true)
            {
                yield return slučajniBroj.NextDouble();
            }
        }

        // 131 Implementirati metodu tako da omogućava vraćanje beskonačnog niza slučajnih brojeva uz zadanu početnu klicu.
        ...
        {
            var slučajniBroj = new Random(klica);
